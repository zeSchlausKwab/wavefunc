...
```json
{
  ...
  "languageCodes": ["en", "es"],
  "tags": ["jazz", "blues"],
  "favicon": "https://station-website.com/favicon.png"
}
```

| Field          | Type          | Required | Description                                       |
|----------------|---------------|----------|---------------------------------------------------|
| name           | string        | Yes      | The name of the radio station                     |
| description    | string        | Yes      | Description of the radio station                  |
| website        | string        | No       | URL to the station's website                      |
| streams        | array         | Yes      | Array of stream objects (at least one required)   |
| countryCode    | string        | No       | ISO 3166-2 country code                          |
| languageCodes  | array         | No       | Array of ISO language codes                       |
| tags           | array         | No       | Array of genre/category tags                      |
| favicon        | string        | No       | URL to station's favicon/logo                     |
...
| language     | Station language                  | ISO language code         |
...
```json
{
  ...
  "kind": 31237,
  "content": "{\"name\":\"FIP Radio\",\"description\":\"Curious and sophisticated: Since 1971 FIP offers a versatile program of jazz, chansons, world music and electronic tunes.\",\"website\":\"https://www.radio.net/s/fip\",\"streams\":[{\"url\":\"https://icecast.radiofrance.fr/fiprock-hifi.aac\",\"format\":\"audio/aac\",\"quality\":{\"bitrate\":128000,\"codec\":\"aac\",\"sampleRate\":44100},\"primary\":true}]}",
  "tags": [
    ["d", "fip01"],
    ["name", "FIP Radio"],
    ["description", "Curious and sophisticated: Since 1971 FIP offers a versatile program of jazz, chansons, world music and electronic tunes."],
    ["i", "FIP Radio"],
    ["t", "jazz"],
    ["t", "world"],
    ["t", "electronic"],
...
Favorites events are used to store a user's favorite radio stations as a list.
...
```json
{
  ...
  "favorites": [
    {
      "event_id": "event_id_of_station_1",
      "name": "Station Name 1",
      "added_at": 1690000000
    },
    {
      "event_id": "event_id_of_station_2",
      "name": "Station Name 2",
      "added_at": 1690000001
    }
  ]
...
| favorites     | array         | Yes      | Array of favorite item objects                     |

#### Favorite Item Object

| Field         | Type          | Required | Description                                        |
|---------------|---------------|----------|----------------------------------------------------|
| event_id      | string        | Yes      | Event ID of the favorited station                  |
| name          | string        | Yes      | Name of the favorited station                      |
| added_at      | number        | Yes      | Unix timestamp when the station was added          |
...
```json
{
  ...
  "created_at": 1690000000,
  "kind": 30078,
  "content": "{\"name\":\"My Favorite Stations\",\"description\":\"Stations I listen to every day\",\"favorites\":[{\"event_id\":\"event_id_of_station_1\",\"name\":\"FIP Radio\",\"added_at\":1690000000},{\"event_id\":\"event_id_of_station_2\",\"name\":\"Soma FM Drone Zone\",\"added_at\":1690000001}]}",
  "tags": [
