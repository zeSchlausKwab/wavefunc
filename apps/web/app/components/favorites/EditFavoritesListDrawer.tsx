...
import { FavoritesList, FavoritesListContent } from "@wavefunc/common";
...
export function EditFavoritesListDrawer({
  favoritesList,
  isOpen,
  onClose,
}: EditFavoritesListDrawerProps) {
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-center space-x-2 text-destructive">
              ...
              <h3 className="font-semibold">
                Are you sure you want to delete this favorites list?
              </h3>
            </div>
            <p className="text-sm text-muted-foreground">
              This action cannot be undone. The favorites list will be
              permanently deleted.
            </p>
