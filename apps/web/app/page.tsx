...
export default function Home({ onPlayStation }) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-primary font-press-start-2p">Your Radio Stations</h2>
      <div className="space-y-6">
        {groups.map((group) => (
          <StationGroup
            key={group.id}
            ...
            stations={group.stationIds.map((id) => stations.find((s) => s.id === id)).filter(Boolean)}
      ...
      <div className="text-center">
        <Button className="bg-primary hover:bg-primary-foreground text-white font-press-start-2p text-xs" asChild>
